...
import { Phone, Mail, Headphones, BookOpen, Menu, X, ChevronDown, Newspaper } from "lucide-react"; 
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden lg:block">
            <ul className="flex gap-6 text-[10px] font-black text-[#002147] uppercase items-center">
              ...
              {/* Added Courses Here */}
              <li><Link to="/courses" className="hover:text-red-600 text-red-600">Our Courses</Link></li>
              ...
              {/* Admission Link as a Button */}
              <li>
                <Link 
                  to="/courses"
                  className="bg-red-600 text-white px-5 py-2 rounded-full hover:bg-[#002147] transition-all shadow-md active:scale-95"
                >
                  Apply Now
                </Link>
              </li>
        ...
        <div className="p-6 flex flex-col h-full text-white">
          ...
          <nav className="flex-grow">
            <ul className="space-y-6 text-sm font-black uppercase tracking-widest">
              ...
              <li><Link onClick={() => setIsMenuOpen(false)} to="/courses" className="block py-2 border-b border-white/10 text-red-400">Our Courses</Link></li>
              <li><Link onClick={() => setIsMenuOpen(false)} to="/news" className="flex items-center gap-2 py-2 border-b border-white/10"><Newspaper size={18} /> Latest News</Link></li>
